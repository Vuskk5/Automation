...
public interface Select extends Element {
    ...
    /**
     * Selects a value between the specified range.
     */
    void selectRandomRange(int start, int end);

    /**
     * Selects a value with the given start offset.
     */
    void selectRandomWithOffset(int offset);
}
